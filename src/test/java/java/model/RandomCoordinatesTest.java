...
//   */
//  private boolean areCoordinatesValid(int height,
//  int width, List<Coord> coordinates, Direction direction) {
...
////    assertEquals(ShipType.CARRIER.getSize(),
// RandomCoordinates.coord_count(ShipType.CARRIER));
////    assertEquals(ShipType.BATTLESHIP.getSize(),
// RandomCoordinates.coord_count(ShipType.BATTLESHIP));
////    assertEquals(ShipType.DESTROYER.getSize(),
// RandomCoordinates.coord_count(ShipType.DESTROYER));
////    assertEquals(ShipType.SUBMARINE.getSize(),
// RandomCoordinates.coord_count(ShipType.SUBMARINE));
////  }
//}
